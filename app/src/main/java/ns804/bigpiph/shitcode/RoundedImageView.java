...
public class RoundedImageView extends ImageView {
    ...
    public static Bitmap getCroppedBitmap(Bitmap pic, int radius) {
        Bitmap sbmp;
        //Bitmap bitmap = Bitmap.createScaledBitmap(pic, (pic.getWidth()*2),(pic.getHeight()*2) , false);
        Bitmap bmp = cropToSquare(pic);
