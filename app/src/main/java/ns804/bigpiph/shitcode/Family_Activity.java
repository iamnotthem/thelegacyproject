...
import ns804.bigpiph.shitcode.adapters.GridFamAdapter;
 ...
 */
public class Family_Activity extends AppCompatActivity implements Runnable, SeekBar.OnSeekBarChangeListener, ResponseInterface {
    ...
    ExpandableHeightGridView famMember;
    ...
    Parcelable f;
    ImageView imageViewItem, imageViewItem2, imageViewItem3, imageViewItem4, profilePic;
    ...
    ArrayList<FAMILY> famArrayList;

    @Override
    protected void onCreate(Bundle savedInstancestate) {
        super.onCreate(savedInstancestate);
        context = Family_Activity.this;
        ...
        bundle = new Bundle();
        members = getIntent().getBundleExtra("bundle").getParcelableArrayList("fam");
        ...
        topScroll = (RelativeLayout)findViewById(R.id.topscroll);
        seekbar = (SeekBar)findViewById(R.id.seekbar);
        famMember = (ExpandableHeightGridView) findViewById(R.id.familyPor);
        famMember.setExpanded(true);
        ...
        topScroll.setOnTouchListener(new OnSwipeTouchListener(Family_Activity.this) {
            public void onSwipeTop() {
                Toast.makeText(Family_Activity.this, "top", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onSwipeBottom() {
                Toast.makeText(Family_Activity.this, "bottom", Toast.LENGTH_SHORT).show();
            }
        ...
        for (Object i : members) {
            ...
            feature = eps.getFeature();
            if (eps.getFeature().equalsIgnoreCase("true")) {

                zs = eps;
                Picasso.with(context).load(image).resize(width, height).into(profilePic);
            }
        ...
        profilePic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, Individual_Fam.class);
                bundle.putParcelable("indi", zs);
                bundle.putParcelableArrayList("track", track);
                intent.putExtra("bundle", bundle);
                Log.d("animationFired","bundle heightM:"+heightM);
                startActivity(intent);

            }
        });
        adapter = new GridFamAdapter(context, members, thu, thu);
        famMember.setAdapter(adapter);

        famMember.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(context, Individual_Fam.class);
                Log.d("familyGrid","fired");
                FAMILY fam = members.get(position);
                bundle.putParcelable("indi", fam);
                if(heightM > 0) {
...
//kfogg begin
    ...
    private void upDateUI(Intent serviceIntent){
        ...
        if(!pla) {
            ...
            Log.d("animationFired","pla = false: "+pla);
    ...
    private void BufferDialogue(){
        ...
        pdBuff = ProgressDialog.show(Family_Activity.this,"Buffering...", "Acquiring song: "+info, true);
    }
